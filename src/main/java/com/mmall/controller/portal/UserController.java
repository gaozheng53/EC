...
public class UserController {
    ...
    // @ResponseBody 用于转json格式，详情见dispatcher-servlet.xml配置
    ...
    public ServerResponse<String> logout(HttpSession session){
        session.removeAttribute(Const.CURRENT_USER);   // 删掉session即可
    ...
    public ServerResponse<User> updateUserInfo(HttpSession session,User user){
        ...
        user.setId(currentUser.getId()); // 防止横向越权，ID，username被变化
